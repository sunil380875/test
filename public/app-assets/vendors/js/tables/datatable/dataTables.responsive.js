...
(function (factory) {
   ...
   *
   * Responsive for DataTables has two modes of administration, which can used
   ...
   * from the table that has been hidden. There are also two modes of administration
